...
Original file is located at
    https://colab.research.google.com/drive/1z7fHIrpyskVOnjwlHfkvQqJNi7gUEgWv
"""
...
def healthai_response(prompt):
    if not is_health_related(prompt):
        return "⚠️ I'm designed to answer only health-related questions. Please ask something related to health, symptoms, treatment, or wellness."
